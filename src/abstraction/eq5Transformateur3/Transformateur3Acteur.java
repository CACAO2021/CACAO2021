...
public abstract class Transformateur3Acteur implements IActeur {
	...
	public Transformateur3Acteur() {
		...
		this.stock_min_feves_HBE = new Variable("Stock minimal de fèves haute bio équitable", this, 120000);
		this.stock_min_feves_moyenne = new Variable("Stock minimal de fèves de moyenne gamme", this, 120000);
