...
public class Transformateur3Stock extends Transformateur3Acteur {
	...
	public Transformateur3Stock() {
		...
		Variable value_Tablette_Haute_Bio_Equitable = new Variable("Stock de tablettes haute bio équitable", this, 250);
		Variable value_Tablette_moyenne = new Variable("Stock de tablettes gamme moyenne", this, 250);
		Variable value_Confiserie_moyenne = new Variable("Stock de confiseries", this, 250);
		
		Variable value_Feve_Haute_Bio_Equitable = new Variable("Stock de fèves haute bio équitable", this, 250);
		Variable value_Feve_Moyenne = new Variable("Stock de fèves gamme moyenne", this, 250);
