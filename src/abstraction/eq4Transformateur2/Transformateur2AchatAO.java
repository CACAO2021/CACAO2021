...
public class Transformateur2AchatAO extends Transformateur2AchatCC implements IAcheteurFevesAO {
	...
	public OffreAchatFeves getOffreAchat() {
		if (get_stock(Feve.FEVE_BASSE) < quantite_totale_demandee_basse / nombre_step_total_basse + mini_stock_bas) {
			return new OffreAchatFeves(this, Feve.FEVE_BASSE,quantite_totale_demandee_basse - get_stock(Feve.FEVE_BASSE));
		}
		if (get_stock(Feve.FEVE_MOYENNE) < quantite_totale_demandee_moyenne / nombre_step_total_moyenne + mini_stock_moyen) {
