...
public class ExempleAbsAcheteurFevesAO implements IActeur {
	...
	public ExempleAbsAcheteurFevesAO() {
		NB_INSTANCES++;
	...
	public String getNom() {
		return "A.FevesAO"+numero;
	}

	public String getDescription() {
		return "Acheteur de feves par A.O. "+this.numero;
	}
