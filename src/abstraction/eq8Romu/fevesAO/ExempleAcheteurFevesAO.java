...
public class ExempleAcheteurFevesAO extends ExempleAbsAcheteurFevesAO implements IAcheteurFevesAO {

	private Feve feve;
	private double prixMax;
	private double qMin, qMax;

	public ExempleAcheteurFevesAO(Feve feve, double prixMax, double qMin, double qMax) {
		super();
		this.feve = feve;
